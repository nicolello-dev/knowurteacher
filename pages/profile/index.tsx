...
export default function ViewProfile() {
    ...
    return (
      <>
        ...
        <h1 className="container max-w-lg text-3xl text-center mx-auto my-32">
          It seems like you haven&apos;t logged in. Please try reloading the
          page or logging back in.
        </h1>
        <Footer />
      </>
    );
  ...
  return (
    <>
      <Header />
      <h1 className="text-2xl text-center m-6 mt-0">Your profile:</h1>
      <section className="flex flex-col bg-white dark:bg-black mx-auto p-6 rounded-xl container my-6 max-w-lg">
        ...
        <p>
          ...
          <span className="font-bold">
            {userId.loading
              ? "Loading..."
              : userId.data ||
                "An error occurred and we cannot determine your user id"}
          </span>
          <span
            onClick={(_) => {
        ...
        <button
          className="p-6 text-xl background-primary dark:background-primarydark"
          onClick={() => signOut()}
        >
          Sign out
        </button>
