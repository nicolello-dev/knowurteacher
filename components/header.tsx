        ...
        <header className="bg-white p-6 flex flex-row justify-between flex-wrap">
            ...
            <div className="flex flex-row text-white items-center font-sans">
            {
                session ? <>
                    ...
                    <button className="inline-block align-middle text-center select-none font-normal whitespace-no-wrap py-1 px-3 leading-normal no-underline text-black" onClick={() => {signIn(); setShowLabel(true)}}>Log In</button>
                </>
            }
            </div>
        </header>
