...
export default function TeacherProfilePreview({ teacher, button=false }: { teacher: Teacher, button: boolean }) {
    return <div className="relative mx-auto my-6 flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 dark:bg-[#26092a] dark:border-primary" style={{alignItems: 'center', maxWidth: '300px', height: 'max-content'}}>
