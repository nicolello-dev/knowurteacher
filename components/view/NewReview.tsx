...
export default function NewReview({ teacherId } : { teacherId: string }) {
    ...
    function handleOnSubmit(e: any) {
        ...
        toast.promise(
            ...
            }),
            {
                ...
                error: "Error adding your comment. Are you logged in or did you already write one?",
    ...
    if(show == false) {
        return <p className="mx-auto text-center m-32">You already wrote a comment! Please delete your previously-written one and reload the page</p>
    }
