export const svgs = {
    ...
    >
      <g fill-rule="evenodd" clipRule="evenodd">
        <path
          fill="#61bb46"
          stroke="#61bb46"
          strokeMiterlimit="2.61310005"
          strokeWidth="6.28089046"
  ...
  attention: (w: number, h: number, fill: string = "#000000") => (
    <svg
      fill={fill}
      height={h}
      width={w}
    ...
    >
      <g>
        <g>
          <path
            d="M482.592,381.614L288.863,69.966c-11.22-18.044-26.348-27.96-42.656-27.96c-16.32,0-31.456,9.924-42.672,27.976
  ...
  upvote: (w: number, h: number, fill: string = "#000000") => (
    <svg
      fill={fill}
      width={w}
      height={h}
  ...
  downvote: (w: number, h: number, fill: string = "#000000") => (
    <svg
      fill={fill}
      width={w}
      height={h}
  ...
  trash: (w: number, h: number, fill: string = "#000000") => (
    <svg
      fill={fill}
      width={w}
      height={h}
