...
export default function privacyPolicy() {
  return (
    <>
      ...
      >
        <p>
          Know ur teacher Privacy Policy. Last updated: <b>1st July 2023</b>
          <br />
          This Privacy Policy describes how Know ur teacher (the
          &quot;Site&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;)
          collects, uses, and discloses your personal information when you
          visit, use our services, or make a purchase from
          https://www.knowurteacher.com (the &quot;Site&quot;) or otherwise
          communicate with us (collectively, the &quot;Services&quot;). For
          purposes of this Privacy Policy, &quot;you&quot; and &quot;your&quot;
        ...
        <p>
          <br />
          We only collect information given to you by Google through your Google
          Account, when signed in. If you haven&apos;t signed in, we
          haven&apos;t collected any data.
          <br />
        ...
        <ul>
          <li>
            <p>
              Your comments, including the teacher you commented on and its
              text.
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <p>
              Your Google account information, specifically your username, email
              and profile picture.
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <p>
              To save your user information in a database, and to ensure all the
              comments come from genuine people, avoiding mass negative comments
              of teachers.
            </p>
          </li>
        </ul>
        ...
        <p>
          The Services may enable you to post user-generated content. This
          content will be anonymous for anyone else except us
          <br />
        </p>
        ...
        <p>
          ...
          party service providers and partners in these countries. If we
        ...
        <p>
          ...
          available to you, please email us at nicolamigone179@gmail.com.
        </p>
      </div>
      <Footer />
    </>
